          ...
          >
            ...
            <AnimatePresence>
              {isOpen && (
                <motion.div
                  ...
                  className="bg-[#161B22] border border-[rgba(0,200,150,0.14)] rounded-3xl p-6 shadow-[0_30px_80px_-10px_rgba(0,0,0,0.65)] backdrop-blur-2xl w-72"
                >
                  {/* Header */}
                  ...
                  <div className="flex items-center gap-3 mb-5 p-3 bg-white/[0.02] rounded-2xl border border-white/[0.04]">
                    ...
                    <div>
                      ...
                      <p className="text-white/40 text-[10px] font-mono">Software Developer</p>
                    </div>
                  </div>
            ...
            <motion.button
              ...
              className={`relative flex items-center gap-2.5 px-5 py-3.5 rounded-full text-xs font-mono uppercase font-semibold shadow-[0_20px_60px_-8px_rgba(0,0,0,0.8)] transition-all duration-500 ${
                isOpen
                  ? 'bg-[#161B22] border border-[rgba(0,200,150,0.14)] text-[#F8FAFC]'
